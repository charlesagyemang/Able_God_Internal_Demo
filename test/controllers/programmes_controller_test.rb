...
class ProgrammesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create programme" do
    assert_difference('Programme.count') do
      post programmes_url, params: { programme: { facilitator: @programme.facilitator, name: @programme.name, references: @programme.references, time_allocation_in_minutes: @programme.time_allocation_in_minutes } }
    end
  ...
  test "should update programme" do
    patch programme_url(@programme), params: { programme: { facilitator: @programme.facilitator, name: @programme.name, references: @programme.references, time_allocation_in_minutes: @programme.time_allocation_in_minutes } }
