class NotifyMembersJob < ApplicationJob
  ...
  def perform(name, number, day="SUNDAY")
    ...
    thursday_message = "Hey #{name}, this is Bishop, I hope I caught you at the right time. I wanted to remind you that today is Power Thursday. We will be holding a very powerful prayer session between 9:00 and 12:00 at the church premises. If you have time on your hands please do well to pass by. if you cant't make it you can send in your prayer requests and we will remind you in prayers. Have a nice day #{name}. See you"
